define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'app/article_like/index' + location.search,
                    add_url: 'app/article_like/add',
                    edit_url: 'app/article_like/edit',
                    del_url: 'app/article_like/del',
                    multi_url: 'app/article_like/multi',
                    table: 'app_article_like',
                }
            });

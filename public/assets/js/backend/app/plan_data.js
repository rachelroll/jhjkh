define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'app/plan_data/index' + location.search,
                    add_url: 'app/plan_data/add',
                    edit_url: 'app/plan_data/edit',
                    del_url: 'app/plan_data/del',
                    multi_url: 'app/plan_data/multi',
                    table: 'app_plan_data',
                }
            });
